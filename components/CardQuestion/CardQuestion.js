...
export default function CardQuestion({ lesson }) {
    ...
    return (
        <View>
            <View style={styles.cardContainer}>
                {wordSelected ? <Text style={styles.textWord}>{wordSelected.furigana || wordSelected.word || wordSelected.jp}</Text> : <Text>Loading...</Text>}
            </View >
            {poolWords &&
